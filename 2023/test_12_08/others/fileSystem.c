...
void operate()
{
    ...
    {
        char command[20];
        char name[][8] = {"create", "delete", "open", "close", "read", "write", "bye"};
        puts("请输入命令: \n");
        scanf("%s", command);
...
void print()
{
    puts("***************文件系统模拟实验*****************\n");
    puts("***使用说明***:\n");
    puts("本文件系统共有6个用户分别是user1 user2 user3 user4 user5 user6\n");
    puts("系统命令有create, delete, open, close, read, write, bye\n");
    puts("bye----------------------------------------退出系统");
}
